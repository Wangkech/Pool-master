...
function Navbar({ setView, view }) {
  return (
    <nav
      ...
      className="bottom-nav shadow] row-3 flex w-[90vw] items-center justify-evenly self-center justify-self-center rounded-[5rem] bg-(--accent-bg) py-1.5 bg-blend-color shadow"
    >
