...
function PastRoundPlayers({ players, winnerId, fullView }) {
  return (
    <>
      {fullView && (
        <div
          className={` ${fullView && " translate-none transition-all duration-700 ease-in-out"} ${!fullView && "translate-y-28 transition-all duration-700 ease-in-out"}`}
        >
